...
\input{Chapter1.tex} % Introduction
\input{Chapter2.tex} % Background
\input{Chapter3.tex} % Requirements and Design (merged: was Requirements + Analysis and Design)
\input{Chapter5.tex} % Implementation
\input{Chapter6.tex} % Test Plan and Verification
\input{Chapter7.tex} % Results
\input{Chapter8.tex} % Critical Evaluation
...
\appendix
\input{AppendixA.tex} % Ethical, Legal and Safety
\input{AppendixB.tex} % User and Deployment Guide
